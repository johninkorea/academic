...
# equation_inputs=np.array([learingrate, number_of_epoch, nodes_per_hidden, number_of_hidden])
...
gene_space=[{'low': 1e-4, 'high': 1e-1}, {'low': 1, 'high': 5}, {'low': 1, 'high': 10}, {'low': 1, 'high': 10}]
